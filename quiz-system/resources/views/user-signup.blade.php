...
<div class=" bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <form action="/user-signup" method="post" class="space-y-4">
        @csrf
        <div>
            <label for="" class="text-gray-600 mb-1 text-md font-bold ">User Name</label>
       ...
       @enderror
        ...
        <div>
            <label for="" class="text-gray-600 mb-1 font-bold">User Email</label>
       ...
       @enderror
        ...
        <div>
            <label for="" class="text-gray-600 mb-1 font-bold">Confirm Password</label>
